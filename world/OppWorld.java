...
/* 
 * Our Class to store the state of the opponents world
 */
...
public class OppWorld {
	...
	//public ConfigurationCounter size4Battleship; // size 14 Frigate
	public ConfigurationCounter size14Frigate;
	//public ConfigurationCounter size3Submarine; // size 13 Submarine
	public ConfigurationCounter size13Submarine;
	//public ConfigurationCounter size3Cruiser; // size 22 Cruiser
